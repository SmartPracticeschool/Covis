...
def check_state(state):
    if state == 'More About Andhra Pradesh':
        ...
        args = [states_dates_dict['uttar pradesh'], uttar_tags_plot, 'Uttar Pradesh',"20,42,00,000",list(state_tags_dict['uttar pradesh'].keys()),
                    list(state_tags_dict['uttar pradesh'].values()), table_dict['Positive_sentiments']['uttar pradesh'], table_dict['Negative_sentiments']['uttar pradesh'], table_dict['Neutral_sentiments']['uttar pradesh'], table_dict['Positive_number']['uttar pradesh'], table_dict['Negative_number']['uttar pradesh'], table_dict['Neutral_number']['uttar pradesh'], "469"]
        ...
        args = [states_dates_dict['uttarakhand'], uttarakhand_tags_plot, 'Uttarakhand',"1,01,00,000",list(state_tags_dict['uttarakhand'].keys()),
                    list(state_tags_dict['uttarakhand'].values()), table_dict['Positive_sentiments']['uttarakhand'], table_dict['Negative_sentiments']['uttarakhand'], table_dict['Neutral_sentiments']['uttarakhand'], table_dict['Positive_number']['uttarakhand'], table_dict['Negative_number']['uttarakhand'], table_dict['Neutral_number']['uttarakhand'], "356"]
        ...
        args = [states_dates_dict['west bengal'], west_tags_plot, 'West Bengal',"9,03,00,000",list(state_tags_dict['west bengal'].keys()),
                    list(state_tags_dict['west bengal'].values()), table_dict['Positive_sentiments']['west bengal'], table_dict['Negative_sentiments']['west bengal'], table_dict['Neutral_sentiments']['west bengal'], table_dict['Positive_number']['west bengal'], table_dict['Negative_number']['west bengal'], table_dict['Neutral_number']['west bengal'], "322"]
